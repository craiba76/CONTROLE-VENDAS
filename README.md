...
<head>
  ...
  <title>BHSI Business Hub</title>
  
  <!-- SEO -->
  <meta property="og:title" content="BHSI Business Hub" />
  <meta property="og:locale" content="pt_BR" />
  <meta property="og:url" content="https://craiba76.github.io/BHSI-Business-Hub/" />
  <meta property="og:site_name" content="BHSI Business Hub" />
  <meta property="og:type" content="website" />
  <meta name="twitter:card" content="summary" />
  <meta property="twitter:title" content="BHSI Business Hub" />
  ...
  <style>
    ...
    .login-btn, .add-row-btn, .generate-pdf-btn {
      width: 100%;
      padding: 10px;
    ...
    .login-btn:hover, .add-row-btn:hover, .generate-pdf-btn:hover {
...
<body>
  ...
  <div class="welcome-msg" id="welcomeContainer" style="display: none;">
    Seja Bem-Vindo ao BHSI Business Hub!
  </div>

  <!-- Planilha Inteligente -->
  <div class="table-container" id="tableContainer" style="display: none;">
    <h1>BHSI Business Hub - Controle de Precificação</h1>
    <table id="priceTable">
      <thead>
        <tr>
          <th>Produto</th>
    ...
    <button class="generate-pdf-btn" onclick="gerarPDF()">Gerar Relatório PDF</button>
  </div>
